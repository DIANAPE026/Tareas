...
| **POSITIVO** | CP-POS-004 | Acceso a "Conductores" en Monitoreo | Estar en el módulo de Monitoreo. | Buscar la opción/link "Conductores". | La opción es visible y funcional dentro del módulo. | Alta | ✅ APROBADO (MANUAL) |
| **NEGATIVO** | CP-NEG-001 | Ocultamiento de Iconos sin Conductor | Ruta SIN conductor asignado. | Ingresar a 'Generar Rutas' y ubicar un registro vacío de conductor. | Los iconos de Foto y Teléfono NO deben mostrarse. | Alta | ✅ APROBADO (MANUAL) |
| **BORDE** | CP-BOR-001 | Conductor sin foto registrada | Conductor asignado pero sin archivo de imagen. | Hacer clic en el icono de la foto. | El modal se abre pero se muestra vacío o con placeholder, sin romper la UI. | Baja | ✅ APROBADO (MANUAL) |
| **BORDE** | CP-BOR-002 | Conductor sin teléfonos registrados | Conductor asignado sin números en BD. | Hacer clic en el icono de teléfono. | El modal muestra: "Personal: -" y "Corporativo: -". | Media | ✅ APROBADO (MANUAL) |
| **BORDE** | CP-BOR-003 | Conductor con un solo teléfono | Solo tiene nro personal o solo corporativo. | Hacer clic en el icono de teléfono. | Muestra el número existente y "-" para el faltante. | Media | ✅ APROBADO (MANUAL) |
