...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **POSITIVO** | CP-POS-001 | Visibilidad de Iconos en Rutas | Ruta con conductor asignado. | Ingresar a 'Generar Rutas' y ubicar un registro con conductor. | Se visualizan los iconos de Foto (cámara/imagen) y Teléfono. | Alta | ⏳ Pendiente |
| **POSITIVO** | CP-POS-002 | Visualización de Foto del Conductor | Registro con icono de foto activo. | Hacer clic en el icono de la foto. | Se abre un modal (pop-up) que muestra la imagen del conductor. | Media | ⏳ Pendiente |
| **POSITIVO** | CP-POS-003 | Visualización de Teléfonos (Ambos) | Conductor con nro personal y corporativo. | Hacer clic en el icono de teléfono. | El modal muestra: "Personal: [Número]" y "Corporativo: [Número]". | Alta | ⏳ Pendiente |
